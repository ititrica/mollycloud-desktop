...
export function loadSettings(): Settings {
  try {
    ...
    const s: Settings = { ...structuredClone(DEFAULTS), ...parsed,
      assistant: { ...DEFAULTS.assistant, ...parsed.assistant },
      boundsPadding: { ...DEFAULTS.boundsPadding, ...parsed.boundsPadding },
    };
