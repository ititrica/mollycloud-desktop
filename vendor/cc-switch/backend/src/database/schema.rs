...
impl Database {
    ...
    pub(crate) fn create_tables_on_conn(conn: &Connection) -> Result<(), AppError> {
        ...
        conn.execute("CREATE TABLE IF NOT EXISTS proxy_config (
            ...
            listen_port INTEGER NOT NULL DEFAULT 24327, enable_logging INTEGER NOT NULL DEFAULT 1,
        ...
        let _ = conn.execute(
            "ALTER TABLE proxy_config ADD COLUMN listen_port INTEGER NOT NULL DEFAULT 24327",
            [],
        );
        let _ = conn.execute(
    ...
    fn migrate_v1_to_v2(conn: &Connection) -> Result<(), AppError> {
        ...
        if Self::table_exists(conn, "proxy_config")? {
            ...
            Self::add_column_if_missing(
                ...
                "proxy_config",
                "listen_port",
                "INTEGER NOT NULL DEFAULT 24327",
            )?;
            Self::add_column_if_missing(
                conn,
                "proxy_config",
    ...
    fn migrate_v13_to_v14(conn: &Connection) -> Result<(), AppError> {
        ...
        conn.execute(
            "CREATE TABLE proxy_config_v14 (
                ...
                listen_port INTEGER NOT NULL DEFAULT 24327,
