    ...
    async fn update_current_claude_provider_syncs_live_when_proxy_takeover_detected_without_backup()
    {
        ...
        write_json_file(
            ...
            &json!({
                "env": {
                    ...
                    "ANTHROPIC_API_KEY": "MOLLY_CCSWITCH_PROXY_MANAGED",
        ...
        assert_eq!(
            live.get("env")
                ...
                .and_then(|v| v.as_str()),
            Some("MOLLY_CCSWITCH_PROXY_MANAGED"),
...
"#
    ...
    async fn update_current_claude_desktop_provider_syncs_profile_when_proxy_takeover_is_active() {
        ...
        assert_eq!(
            ...
            json!("http://127.0.0.1:24327/claude-desktop"),
...
impl ProviderService {
    ...
    pub fn add(
        ...
        // Embedded creation is separate from activation, including the first provider.
        if !add_to_live {
    ...
    pub fn switch(state: &AppState, app_type: AppType, id: &str) -> Result<SwitchResult, AppError> {
        crate::proxy_ownership::require_no_external_proxy(&app_type)?;
        if app_type == AppType::Pi {
        ...
        crate::isolation::validate_settings_content(&app_type, &_provider.settings_config)?;
        build_effective_settings_with_common_config(state.db.as_ref(), &app_type, _provider)?;
        crate::proxy_ownership::backup_original_for_app(&app_type)?;
    ...
    fn validate_provider_settings(app_type: &AppType, provider: &Provider) -> Result<(), AppError> {
        crate::isolation::validate_settings_content(app_type, &provider.settings_config)?;
        match app_type {
            AppType::Claude => {
