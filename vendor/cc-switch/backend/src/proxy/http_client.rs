...
mod tests {
    ...
    fn test_proxy_points_to_loopback() {
        // 设置 CC Switch 代理端口为 24327（默认值）
        set_proxy_port(24327);

        // 只有指向 CC Switch 自己端口的 loopback 地址才返回 true
        assert!(proxy_points_to_loopback("http://127.0.0.1:24327"));
        assert!(proxy_points_to_loopback("socks5://localhost:24327"));
        assert!(proxy_points_to_loopback("127.0.0.1:24327"));
        ...
        assert!(!proxy_points_to_loopback("http://192.168.1.10:24327"));
    }
    ...
    fn test_system_proxy_points_to_loopback() {
        ...
        std::env::set_var("HTTP_PROXY", "http://127.0.0.1:24327");
